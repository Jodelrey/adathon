        ...
        <StyledProductsContainer>
          { data.map((product, index )=>
            <StyledProductItem key={product.producto_index }>
             ...
             <StyledButton style={{ color: "rgb(125,48,134)", background: "transparent", border: "1px solid rgb(125,48,134)" }}>Eliminar</StyledButton>
             <StyledButton style={{ margin: "15px 0px 5px 35px" }}>Editar</StyledButton>
